...
define("_MAIL_SMTP_PORT","<?php echo $_REQUEST['smtp_port'];?>"); 
...
INSERT IGNORE INTO `settings` VALUES ('from_name', 'Seu Nome');
...
<div class="box">
	...
	foreach($folders as $folder){
		if(!is_dir($folder)){
			echo "A pasta '$folder' nao existe, criar a pasta. <br>";
		}else if(!is_writable($folder)){
			echo "A pasta '$folder' nao pode ser gravada(WRITABLE), por favor de permissao a pasta (obs: botao direito na pasto pelo FTP, sete a permissao, para escrita total). <br>";
		}else{
			echo "A pasta '$folder' esta OK <br>";
		}
...
<div class="box">
	...
	<table cellpadding="4">
		...
		<tr>
			<td><label>Senha da Base de Dados</label></td>
			<td><div class="form_field"><input type="text" name="db_pass" id="db_pass" value="senha"></div></td>
		</tr>
		<tr>
			<td><label>Host da Base de Dados</label></td>
...
<div class="box">
	...
	<table cellpadding="4">
		...
		<tr>
			<td><label>Senha do SMTP</label></td>
			<td><div class="form_field"><input type="text" name="smtp_pass" id="smtp_pass" value=""><div class="form_field"></td>
		</tr>
		<tr>
			<td><label>Porta do SMTP</label></td>
			<td><div class="form_field"><input type="text" name="smtp_port" id="smtp_port" value="587"><div class="form_field"></td>
		</tr>
	</table>
</div>

<h2><span>Gerar arquivo de Configuracao</span></h2>
<div class="box">
	<input type="submit" name="submit" id="submit" value="Confirmar" class="submit green">
</div>
